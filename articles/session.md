...
#> [1] Amelia_1.8.3         Rcpp_1.1.1           microbenchmark_1.5.0
#> [4] lavaan_0.6-21        semmcci_1.1.6       
#> 
#> loaded via a namespace (and not attached):
#>  [1] shape_1.4.6.1     xfun_0.56         sem_3.1-16        rsem_0.5.1       
#>  [5] lattice_0.22-7    quadprog_1.5-8    vctrs_0.7.1       tools_4.5.2      
#>  [9] Rdpack_2.6.6      generics_0.1.4    stats4_4.5.2      parallel_4.5.2   
#> [13] tibble_3.3.1      pan_1.9           pkgconfig_2.0.3   jomo_2.7-6       
#> [17] Matrix_1.7-4      arm_1.14-4        lifecycle_1.0.5   compiler_4.5.2   
#> [21] mnormt_2.1.2      codetools_0.2-20  mi_1.2            snow_0.4-4       
#> [25] glmnet_4.1-10     mice_3.19.0       pillar_1.11.1     nloptr_2.2.1     
#> [29] tidyr_1.3.2       MASS_7.3-65       reformulas_0.4.4  iterators_1.0.14 
#> [33] rpart_4.1.24      boot_1.3-32       abind_1.4-8       rProject_0.0.25  
#> [37] foreach_1.5.2     mitml_0.4-5       nlme_3.1-168      tidyselect_1.2.1 
#> [41] dplyr_1.2.0       purrr_1.2.1       splines_4.5.2     snowfall_1.84-6.3
#> [45] rprojroot_2.1.1   grid_4.5.2        cli_3.6.5.9000    magrittr_2.0.4   
#> [49] survival_3.8-3    broom_1.0.12      pbivnorm_0.6.0    foreign_0.8-90   
#> [53] bmemLavaan_0.7    backports_1.5.0   otel_0.2.0        nnet_7.3-20      
#> [57] lme4_1.1-38       coda_0.19-4.1     evaluate_1.0.5    knitr_1.51       
#> [61] rbibutils_2.4.1   rlang_1.1.7       glue_1.8.0        minqa_1.2.8      
#> [65] R6_2.6.1
```
...
#> distributional    "distributional"    "0.6.0"     
#> distro            "distro"            "0.1.1"     
#> doBy              "doBy"              "4.7.1"     
#> docopt            "docopt"            "0.7.2"     
...
## Memory
    ...
    #> Mem:            23Gi       4.2Gi       6.2Gi        23Mi        13Gi        18Gi
    #> Swap:           11Gi       5.0Mi        11Gi
    #> Total:          34Gi       4.2Gi        17Gi
