...
differences between standardized regression coefficients in multiple
groups.
...
We regress `Y1` on `X1`, `X2`, and `X3`. We label the regression
coefficient $`\gamma_{1}`$ for the three groups as `gamma1.g1`,
`gamma1.g2`, and `gamma1.g3`, $`\gamma_{2}`$ for the three groups as
`gamma2.g1`, `gamma2.g2`, and `gamma2.g3`, and $`\gamma_{3}`$ for the
three groups as `gamma3.g1`, `gamma3.g2`, and `gamma3.g3`.
...
#> Standardized Monte Carlo Confidence Intervals
#>                est     se     R    2.5%   97.5%
#> gamma1.g1   0.0568 0.0191 20000  0.0195  0.0946
#> gamma2.g1   0.1985 0.0187 20000  0.1616  0.2351
#> gamma3.g1   0.2500 0.0150 20000  0.2209  0.2792
#> Y1~~Y1      0.8215 0.0103 20000  0.8001  0.8409
...
#> gamma1.g12 -0.0821 0.0251 20000 -0.1319 -0.0330
#> gamma1.g13 -0.0294 0.0257 20000 -0.0799  0.0211
#> gamma1.g23  0.0527 0.0236 20000  0.0070  0.0993
#> gamma2.g12  0.0193 0.0244 20000 -0.0285  0.0672
#> gamma2.g13 -0.0572 0.0248 20000 -0.1057 -0.0082
#> gamma2.g23 -0.0765 0.0228 20000 -0.1214 -0.0318
#> gamma3.g12  0.0811 0.0204 20000  0.0412  0.1210
#> gamma3.g13  0.0211 0.0204 20000 -0.0189  0.0615
#> gamma3.g23 -0.0601 0.0196 20000 -0.0987 -0.0217
```

## References

Kwan, J. L. Y., & Chan, W. (2011). Comparing standardized coefficients
in structural equation modeling: A model reparameterization approach.
