...
#> Monte Carlo Confidence Intervals
#>              est     se     R    2.5%  97.5%
#> cp        0.2335 0.0293 20000  0.1762 0.2913
#> b         0.5113 0.0296 20000  0.4535 0.5696
#> a         0.4809 0.0283 20000  0.4248 0.5359
#> X~~X      1.0591 0.0498 20000  0.9605 1.1559
#> Y~~Y      0.5542 0.0268 20000  0.5012 0.6066
#> M~~M      0.7564 0.0361 20000  0.6845 0.8257
#> Y~1      -0.0127 0.0254 20000 -0.0615 0.0375
#> M~1      -0.0223 0.0293 20000 -0.0794 0.0350
#> X~1       0.0025 0.0339 20000 -0.0632 0.0694
#> indirect  0.2458 0.0201 20000  0.2073 0.2864
#> direct    0.2335 0.0293 20000  0.1762 0.2913
#> total     0.4794 0.0285 20000  0.4241 0.5347
```
...
#> Standardized Monte Carlo Confidence Intervals
#>              est     se     R   2.5%  97.5%
#> cp        0.2409 0.0298 20000 0.1825 0.2990
#> b         0.5128 0.0270 20000 0.4590 0.5647
#> a         0.4946 0.0256 20000 0.4434 0.5433
#> X~~X      1.0000 0.0000 20000 1.0000 1.0000
#> Y~~Y      0.5568 0.0252 20000 0.5079 0.6061
#> M~~M      0.7554 0.0252 20000 0.7048 0.8034
#> indirect -0.0127 0.0188 20000 0.2174 0.2911
#> direct   -0.0222 0.0298 20000 0.1825 0.2990
#> total     0.0024 0.0256 20000 0.4431 0.5436
```
