...
#> Monte Carlo Confidence Intervals
#>              est     se     R    2.5%  97.5%
#> cp        0.2335 0.0295 20000  0.1753 0.2908
#> b         0.5113 0.0297 20000  0.4531 0.5698
#> a         0.4809 0.0287 20000  0.4247 0.5364
#> X~~X      1.0591 0.0492 20000  0.9622 1.1545
#> Y~~Y      0.5542 0.0267 20000  0.5019 0.6064
#> M~~M      0.7564 0.0362 20000  0.6858 0.8284
#> Y~1      -0.0127 0.0252 20000 -0.0621 0.0367
#> M~1      -0.0223 0.0288 20000 -0.0790 0.0348
#> X~1       0.0025 0.0337 20000 -0.0632 0.0685
#> indirect  0.2458 0.0202 20000  0.2075 0.2867
#> direct    0.2335 0.0295 20000  0.1753 0.2908
#> total     0.4794 0.0284 20000  0.4234 0.5352
```
...
#> Standardized Monte Carlo Confidence Intervals
#>              est     se     R   2.5%  97.5%
#> cp        0.2409 0.0300 20000 0.1813 0.2990
#> b         0.5128 0.0271 20000 0.4588 0.5656
#> a         0.4946 0.0258 20000 0.4427 0.5438
#> X~~X      1.0000 0.0000 20000 1.0000 1.0000
#> Y~~Y      0.5568 0.0250 20000 0.5066 0.6049
#> M~~M      0.7554 0.0254 20000 0.7043 0.8040
#> indirect -0.0127 0.0189 20000 0.2170 0.2910
#> direct   -0.0222 0.0300 20000 0.1813 0.2990
#> total     0.0024 0.0257 20000 0.4427 0.5437
```
