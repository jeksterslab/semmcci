...
#> Monte Carlo Confidence Intervals
#>              est     se     R    2.5%  97.5%
#> cp        0.2335 0.0292 20000  0.1774 0.2917
#> b         0.5113 0.0296 20000  0.4531 0.5690
#> a         0.4809 0.0285 20000  0.4254 0.5371
#> X~~X      1.0591 0.0497 20000  0.9626 1.1573
#> Y~~Y      0.5542 0.0269 20000  0.5016 0.6071
#> M~~M      0.7564 0.0361 20000  0.6858 0.8272
#> Y~1      -0.0127 0.0253 20000 -0.0623 0.0368
#> M~1      -0.0223 0.0291 20000 -0.0783 0.0357
#> X~1       0.0025 0.0340 20000 -0.0634 0.0701
#> indirect  0.2458 0.0201 20000  0.2077 0.2863
#> direct    0.2335 0.0292 20000  0.1774 0.2917
#> total     0.4794 0.0284 20000  0.4244 0.5362
```
...
#> Standardized Monte Carlo Confidence Intervals
#>              est     se     R   2.5%  97.5%
#> cp        0.2409 0.0296 20000 0.1835 0.2992
#> b         0.5128 0.0270 20000 0.4588 0.5644
#> a         0.4946 0.0257 20000 0.4427 0.5440
#> X~~X      1.0000 0.0000 20000 1.0000 1.0000
#> Y~~Y      0.5568 0.0251 20000 0.5074 0.6056
#> M~~M      0.7554 0.0254 20000 0.7041 0.8040
#> indirect -0.0127 0.0188 20000 0.2172 0.2907
#> direct   -0.0222 0.0296 20000 0.1835 0.2992
#> total     0.0024 0.0255 20000 0.4436 0.5433
```
