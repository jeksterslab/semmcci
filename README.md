...
#> Monte Carlo Confidence Intervals
#>              est     se     R    2.5%  97.5%
#> cp        0.2335 0.0292 20000  0.1758 0.2905
#> b         0.5113 0.0295 20000  0.4537 0.5691
#> a         0.4809 0.0283 20000  0.4262 0.5368
#> X~~X      1.0591 0.0493 20000  0.9626 1.1561
#> Y~~Y      0.5542 0.0270 20000  0.5005 0.6070
#> M~~M      0.7564 0.0361 20000  0.6864 0.8273
#> Y~1      -0.0127 0.0252 20000 -0.0628 0.0367
#> M~1      -0.0223 0.0291 20000 -0.0794 0.0344
#> X~1       0.0025 0.0339 20000 -0.0641 0.0685
#> indirect  0.2458 0.0200 20000  0.2083 0.2864
#> direct    0.2335 0.0292 20000  0.1758 0.2905
#> total     0.4794 0.0286 20000  0.4233 0.5348
```
...
#> Standardized Monte Carlo Confidence Intervals
#>              est     se     R   2.5%  97.5%
#> cp        0.2409 0.0296 20000 0.1816 0.2980
#> b         0.5128 0.0267 20000 0.4601 0.5644
#> a         0.4946 0.0255 20000 0.4436 0.5443
#> X~~X      1.0000 0.0000 20000 1.0000 1.0000
#> Y~~Y      0.5568 0.0250 20000 0.5075 0.6056
#> M~~M      0.7554 0.0253 20000 0.7037 0.8033
#> indirect -0.0127 0.0186 20000 0.2175 0.2908
#> direct   -0.0222 0.0296 20000 0.1816 0.2980
#> total     0.0024 0.0257 20000 0.4424 0.5434
```
