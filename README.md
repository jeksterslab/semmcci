...
#> Monte Carlo Confidence Intervals
#>              est     se     R    2.5%  97.5%
#> cp        0.2335 0.0293 20000  0.1755 0.2906
#> b         0.5113 0.0294 20000  0.4538 0.5690
#> a         0.4809 0.0286 20000  0.4252 0.5375
#> X~~X      1.0591 0.0492 20000  0.9628 1.1562
#> Y~~Y      0.5542 0.0268 20000  0.5022 0.6075
#> M~~M      0.7564 0.0357 20000  0.6865 0.8260
#> Y~1      -0.0127 0.0254 20000 -0.0628 0.0366
#> M~1      -0.0223 0.0288 20000 -0.0793 0.0334
#> X~1       0.0025 0.0338 20000 -0.0637 0.0697
#> indirect  0.2458 0.0201 20000  0.2076 0.2868
#> direct    0.2335 0.0293 20000  0.1755 0.2906
#> total     0.4794 0.0285 20000  0.4229 0.5355
```
...
#> Standardized Monte Carlo Confidence Intervals
#>              est     se     R   2.5%  97.5%
#> cp        0.2409 0.0298 20000 0.1813 0.2980
#> b         0.5128 0.0267 20000 0.4602 0.5639
#> a         0.4946 0.0256 20000 0.4440 0.5440
#> X~~X      1.0000 0.0000 20000 1.0000 1.0000
#> Y~~Y      0.5568 0.0251 20000 0.5068 0.6058
#> M~~M      0.7554 0.0253 20000 0.7040 0.8028
#> indirect -0.0127 0.0188 20000 0.2170 0.2910
#> direct   -0.0222 0.0298 20000 0.1813 0.2980
#> total     0.0024 0.0258 20000 0.4426 0.5438
```
