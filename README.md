...
#> Monte Carlo Confidence Intervals
#>              est     se     R    2.5%  97.5%
#> cp        0.2335 0.0292 20000  0.1759 0.2908
#> b         0.5113 0.0294 20000  0.4541 0.5690
#> a         0.4809 0.0286 20000  0.4254 0.5368
#> X~~X      1.0591 0.0499 20000  0.9610 1.1551
#> Y~~Y      0.5542 0.0270 20000  0.5017 0.6076
#> M~~M      0.7564 0.0363 20000  0.6849 0.8266
#> Y~1      -0.0127 0.0253 20000 -0.0613 0.0373
#> M~1      -0.0223 0.0289 20000 -0.0789 0.0349
#> X~1       0.0025 0.0340 20000 -0.0646 0.0684
#> indirect  0.2458 0.0203 20000  0.2069 0.2865
#> direct    0.2335 0.0292 20000  0.1759 0.2908
#> total     0.4794 0.0285 20000  0.4235 0.5350
```
...
#> Standardized Monte Carlo Confidence Intervals
#>              est     se     R   2.5%  97.5%
#> cp        0.2409 0.0297 20000 0.1819 0.2986
#> b         0.5128 0.0268 20000 0.4600 0.5642
#> a         0.4946 0.0258 20000 0.4431 0.5441
#> X~~X      1.0000 0.0000 20000 1.0000 1.0000
#> Y~~Y      0.5568 0.0251 20000 0.5079 0.6061
#> M~~M      0.7554 0.0254 20000 0.7039 0.8037
#> indirect -0.0127 0.0189 20000 0.2168 0.2915
#> direct   -0.0222 0.0297 20000 0.1819 0.2986
#> total     0.0024 0.0257 20000 0.4424 0.5430
```
