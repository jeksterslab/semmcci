...
#> Monte Carlo Confidence Intervals
#>              est     se     R    2.5%  97.5%
#> cp        0.2335 0.0294 20000  0.1755 0.2910
#> b         0.5113 0.0297 20000  0.4524 0.5687
#> a         0.4809 0.0283 20000  0.4251 0.5360
#> X~~X      1.0591 0.0493 20000  0.9610 1.1575
#> Y~~Y      0.5542 0.0269 20000  0.5014 0.6070
#> M~~M      0.7564 0.0362 20000  0.6869 0.8278
#> Y~1      -0.0127 0.0252 20000 -0.0617 0.0375
#> M~1      -0.0223 0.0292 20000 -0.0792 0.0350
#> X~1       0.0025 0.0339 20000 -0.0638 0.0691
#> indirect  0.2458 0.0202 20000  0.2073 0.2858
#> direct    0.2335 0.0294 20000  0.1755 0.2910
#> total     0.4794 0.0287 20000  0.4230 0.5357
```
...
#> Standardized Monte Carlo Confidence Intervals
#>              est     se     R   2.5%  97.5%
#> cp        0.2409 0.0299 20000 0.1813 0.2991
#> b         0.5128 0.0271 20000 0.4582 0.5645
#> a         0.4946 0.0256 20000 0.4428 0.5428
#> X~~X      1.0000 0.0000 20000 1.0000 1.0000
#> Y~~Y      0.5568 0.0252 20000 0.5075 0.6057
#> M~~M      0.7554 0.0252 20000 0.7054 0.8039
#> indirect -0.0127 0.0189 20000 0.2167 0.2902
#> direct   -0.0222 0.0299 20000 0.1813 0.2991
#> total     0.0024 0.0259 20000 0.4424 0.5434
```
