...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0243 100 0.1923 0.2817
#> b        0.5082 0.0237 100 0.4662 0.5560
#> a        0.4820 0.0270 100 0.4428 0.5342
#> X~~X     1.0590 0.0485 100 0.9624 1.1350
#> Y~~Y     0.5462 0.0272 100 0.4983 0.6029
#> M~~M     0.7527 0.0339 100 0.6811 0.8116
#> indirect 0.2449 0.0183 100 0.2114 0.2784
#> direct   0.2333 0.0243 100 0.1923 0.2817
#> total    0.4782 0.0237 100 0.4395 0.5279
```
...
#> 1        Y  ~        X       cp 0.233 0.026  9.147      0    0.175    0.283
#> 2        Y  ~        M        b 0.508 0.032 15.700      0    0.434    0.576
#> 3        M  ~        X        a 0.482 0.028 17.515      0    0.431    0.536
#> 4        X ~~        X          1.059 0.047 22.370      0    0.939    1.162
#> 5        Y ~~        Y          0.546 0.022 25.053      0    0.496    0.588
#> 6        M ~~        M          0.753 0.031 23.971      0    0.697    0.830
#> 7 indirect :=      a*b indirect 0.245 0.020 12.552      0    0.205    0.279
#> 8   direct :=       cp   direct 0.233 0.026  9.101      0    0.175    0.283
#> 9    total := cp+(a*b)    total 0.478 0.026 18.747      0    0.424    0.536
```
