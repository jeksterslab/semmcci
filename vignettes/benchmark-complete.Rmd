...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0298 100 0.1764 0.2858
#> b        0.5082 0.0266 100 0.4577 0.5578
#> a        0.4820 0.0298 100 0.4235 0.5361
#> X~~X     1.0590 0.0473 100 0.9964 1.1646
#> Y~~Y     0.5462 0.0222 100 0.5115 0.5908
#> M~~M     0.7527 0.0337 100 0.6965 0.8145
#> indirect 0.2449 0.0196 100 0.2146 0.2801
#> direct   0.2333 0.0298 100 0.1764 0.2858
#> total    0.4782 0.0293 100 0.4271 0.5315
```
...
#> 1        Y  ~        X       cp 0.233 0.030  7.885      0    0.174    0.292
#> 2        Y  ~        M        b 0.508 0.025 19.983      0    0.443    0.552
#> 3        M  ~        X        a 0.482 0.023 20.560      0    0.433    0.526
#> 4        X ~~        X          1.059 0.047 22.637      0    0.968    1.151
#> 5        Y ~~        Y          0.546 0.025 22.261      0    0.495    0.601
#> 6        M ~~        M          0.753 0.035 21.775      0    0.689    0.819
#> 7 indirect :=      a*b indirect 0.245 0.015 15.827      0    0.211    0.270
#> 8   direct :=       cp   direct 0.233 0.030  7.845      0    0.174    0.292
#> 9    total := cp+(a*b)    total 0.478 0.027 17.470      0    0.419    0.524
```
