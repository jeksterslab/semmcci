...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0270 100 0.1891 0.2835
#> b        0.5082 0.0305 100 0.4491 0.5622
...
#> indirect 0.2449 0.0190 100 0.2048 0.2760
#> direct   0.2333 0.0270 100 0.1891 0.2835
#> total    0.4782 0.0280 100 0.4337 0.5304
```
...
#> 1   MC    76.3147    80.4025    81.54644    81.18965    83.9958    85.9153
#> 2   NB 14182.1735 14326.4562 14411.13578 14387.61815 14560.4813 14645.2749
#>   neval
#> 1    10
#> 2    10
```
...
#> 1   MC   1.000   1.0000   1.0000   1.00   1.0000   1.0000    10
#> 2   NB 185.838 178.1842 176.7231 177.21 173.3477 170.4618    10
```
...
#>   expr        min         lq        mean      median         uq        max
#> 1   MC    21.2021    22.1672    24.50503    22.63175    25.9981    36.5281
#> 2   NB 14134.3659 14281.2560 14341.23312 14332.91880 14378.7577 14564.7808
#>   neval
#> 1    10
#> 2    10
```
...
#> 2   NB 666.6493 644.2517 585.2363 633.3102 553.0696 398.7281    10
```
