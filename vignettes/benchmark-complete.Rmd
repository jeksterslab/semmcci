...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0284 100 0.1775 0.2839
#> b        0.5082 0.0269 100 0.4592 0.5664
#> a        0.4820 0.0262 100 0.4319 0.5275
#> X~~X     1.0590 0.0463 100 0.9533 1.1359
#> Y~~Y     0.5462 0.0250 100 0.5011 0.5985
#> M~~M     0.7527 0.0322 100 0.6878 0.8145
#> indirect 0.2449 0.0185 100 0.2093 0.2763
#> direct   0.2333 0.0284 100 0.1775 0.2839
#> total    0.4782 0.0316 100 0.4124 0.5347
```
...
#> 1        Y  ~        X       cp 0.233 0.024  9.910      0    0.173    0.273
#> 2        Y  ~        M        b 0.508 0.032 15.912      0    0.450    0.581
#> 3        M  ~        X        a 0.482 0.027 17.951      0    0.423    0.528
#> 4        X ~~        X          1.059 0.047 22.446      0    0.984    1.176
#> 5        Y ~~        Y          0.546 0.026 20.877      0    0.499    0.605
#> 6        M ~~        M          0.753 0.034 22.116      0    0.671    0.832
#> 7 indirect :=      a*b indirect 0.245 0.020 12.146      0    0.205    0.297
#> 8   direct :=       cp   direct 0.233 0.024  9.860      0    0.173    0.273
#> 9    total := cp+(a*b)    total 0.478 0.029 16.700      0    0.425    0.533
```
