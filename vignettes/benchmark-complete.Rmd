...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0242 100 0.1940 0.2894
#> b        0.5082 0.0268 100 0.4583 0.5589
#> a        0.4820 0.0276 100 0.4349 0.5381
#> X~~X     1.0590 0.0475 100 0.9661 1.1599
#> Y~~Y     0.5462 0.0251 100 0.4994 0.5962
#> M~~M     0.7527 0.0333 100 0.6905 0.8246
#> indirect 0.2449 0.0185 100 0.2132 0.2784
#> direct   0.2333 0.0242 100 0.1940 0.2894
#> total    0.4782 0.0268 100 0.4324 0.5334
```
...
#> 1        Y  ~        X       cp 0.233 0.028  8.259      0    0.176    0.290
#> 2        Y  ~        M        b 0.508 0.032 15.752      0    0.439    0.576
#> 3        M  ~        X        a 0.482 0.026 18.364      0    0.427    0.530
#> 4        X ~~        X          1.059 0.045 23.573      0    0.963    1.149
#> 5        Y ~~        Y          0.546 0.025 22.165      0    0.495    0.593
#> 6        M ~~        M          0.753 0.035 21.630      0    0.680    0.825
#> 7 indirect :=      a*b indirect 0.245 0.022 11.265      0    0.205    0.291
#> 8   direct :=       cp   direct 0.233 0.028  8.218      0    0.176    0.290
#> 9    total := cp+(a*b)    total 0.478 0.028 17.330      0    0.413    0.522
```
