...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0306 100 0.1743 0.2907
#> b        0.5082 0.0268 100 0.4597 0.5598
#> a        0.4820 0.0227 100 0.4357 0.5238
#> X~~X     1.0590 0.0497 100 0.9752 1.1554
#> Y~~Y     0.5462 0.0234 100 0.5072 0.5912
#> M~~M     0.7527 0.0354 100 0.6879 0.8290
#> indirect 0.2449 0.0178 100 0.2084 0.2738
#> direct   0.2333 0.0306 100 0.1743 0.2907
#> total    0.4782 0.0291 100 0.4169 0.5346
```
...
#> 1        Y  ~        X       cp 0.233 0.025  9.234      0    0.183    0.291
#> 2        Y  ~        M        b 0.508 0.028 18.475      0    0.457    0.569
#> 3        M  ~        X        a 0.482 0.027 17.947      0    0.434    0.537
#> 4        X ~~        X          1.059 0.047 22.323      0    0.937    1.150
#> 5        Y ~~        Y          0.546 0.022 24.717      0    0.507    0.585
#> 6        M ~~        M          0.753 0.033 22.754      0    0.668    0.814
#> 7 indirect :=      a*b indirect 0.245 0.018 13.369      0    0.205    0.287
#> 8   direct :=       cp   direct 0.233 0.025  9.188      0    0.183    0.291
#> 9    total := cp+(a*b)    total 0.478 0.029 16.624      0    0.420    0.542
```
