...
output:
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{Example 7: R-Squared}
...
The Monte Carlo method is used to generate confidence intervals for $R^{2}$ and adjusted $R^{2}$ $\left( \bar{R}^{2}\right)$ in a simple mediation model.
