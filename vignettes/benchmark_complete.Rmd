...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0251 100 0.1911 0.2919
#> b        0.5082 0.0238 100 0.4502 0.5478
#> a        0.4820 0.0286 100 0.4141 0.5347
#> X~~X     1.0590 0.0463 100 0.9501 1.1284
#> Y~~Y     0.5462 0.0244 100 0.4980 0.5922
#> M~~M     0.7527 0.0332 100 0.7052 0.8215
#> indirect 0.2449 0.0180 100 0.2070 0.2746
#> direct   0.2333 0.0251 100 0.1911 0.2919
#> total    0.4782 0.0276 100 0.4315 0.5340
```
...
#> 1        Y  ~        X       cp 0.233 0.027  8.680      0    0.189    0.288
#> 2        Y  ~        M        b 0.508 0.028 18.076      0    0.447    0.565
#> 3        M  ~        X        a 0.482 0.026 18.253      0    0.419    0.535
#> 4        X ~~        X          1.059 0.049 21.493      0    0.963    1.150
#> 5        Y ~~        Y          0.546 0.024 23.000      0    0.494    0.594
#> 6        M ~~        M          0.753 0.032 23.675      0    0.701    0.815
#> 7 indirect :=      a*b indirect 0.245 0.019 12.651      0    0.202    0.285
#> 8   direct :=       cp   direct 0.233 0.027  8.637      0    0.189    0.288
#> 9    total := cp+(a*b)    total 0.478 0.026 18.492      0    0.423    0.527
```
