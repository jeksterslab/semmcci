...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0258 100 0.1883 0.2863
#> b        0.5082 0.0257 100 0.4605 0.5581
#> a        0.4820 0.0289 100 0.4319 0.5352
#> X~~X     1.0590 0.0459 100 0.9620 1.1356
#> Y~~Y     0.5462 0.0242 100 0.4996 0.5819
#> M~~M     0.7527 0.0349 100 0.6680 0.8208
#> indirect 0.2449 0.0180 100 0.2152 0.2823
#> direct   0.2333 0.0258 100 0.1883 0.2863
#> total    0.4782 0.0263 100 0.4383 0.5287
```
...
#> 1        Y  ~        X       cp 0.233 0.026  9.131      0    0.189    0.293
#> 2        Y  ~        M        b 0.508 0.027 18.592      0    0.449    0.559
#> 3        M  ~        X        a 0.482 0.025 19.615      0    0.425    0.535
#> 4        X ~~        X          1.059 0.047 22.423      0    0.961    1.146
#> 5        Y ~~        Y          0.546 0.027 20.052      0    0.486    0.595
#> 6        M ~~        M          0.753 0.036 20.976      0    0.673    0.825
#> 7 indirect :=      a*b indirect 0.245 0.019 13.127      0    0.212    0.283
#> 8   direct :=       cp   direct 0.233 0.026  9.085      0    0.189    0.293
#> 9    total := cp+(a*b)    total 0.478 0.024 20.176      0    0.438    0.525
```
