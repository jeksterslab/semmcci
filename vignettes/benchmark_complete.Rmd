...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0263 100 0.1850 0.2784
#> b        0.5082 0.0273 100 0.4595 0.5597
#> a        0.4820 0.0282 100 0.4272 0.5355
#> X~~X     1.0590 0.0472 100 0.9659 1.1469
#> Y~~Y     0.5462 0.0267 100 0.4927 0.5948
#> M~~M     0.7527 0.0316 100 0.6937 0.8062
#> indirect 0.2449 0.0182 100 0.2129 0.2789
#> direct   0.2333 0.0263 100 0.1850 0.2784
#> total    0.4782 0.0276 100 0.4254 0.5367
```
...
#> 1        Y  ~        X       cp 0.233 0.026  8.817      0    0.184    0.286
#> 2        Y  ~        M        b 0.508 0.027 18.662      0    0.447    0.558
#> 3        M  ~        X        a 0.482 0.024 20.433      0    0.432    0.535
#> 4        X ~~        X          1.059 0.045 23.407      0    0.973    1.151
#> 5        Y ~~        Y          0.546 0.024 22.554      0    0.496    0.591
#> 6        M ~~        M          0.753 0.040 19.023      0    0.671    0.847
#> 7 indirect :=      a*b indirect 0.245 0.018 13.526      0    0.199    0.283
#> 8   direct :=       cp   direct 0.233 0.027  8.773      0    0.184    0.286
#> 9    total := cp+(a*b)    total 0.478 0.025 18.957      0    0.438    0.538
```
