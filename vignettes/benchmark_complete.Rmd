...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0256 100 0.1880 0.2847
#> b        0.5082 0.0263 100 0.4542 0.5576
#> a        0.4820 0.0286 100 0.4308 0.5384
#> X~~X     1.0590 0.0444 100 0.9772 1.1645
#> Y~~Y     0.5462 0.0248 100 0.5039 0.5952
#> M~~M     0.7527 0.0386 100 0.6745 0.8154
#> indirect 0.2449 0.0200 100 0.2115 0.2810
#> direct   0.2333 0.0256 100 0.1880 0.2847
#> total    0.4782 0.0248 100 0.4280 0.5248
```
...
#> 1        Y  ~        X       cp 0.233 0.026  8.931      0    0.168    0.283
#> 2        Y  ~        M        b 0.508 0.025 20.431      0    0.463    0.565
#> 3        M  ~        X        a 0.482 0.028 17.251      0    0.424    0.539
#> 4        X ~~        X          1.059 0.049 21.720      0    0.966    1.175
#> 5        Y ~~        Y          0.546 0.025 21.497      0    0.493    0.599
#> 6        M ~~        M          0.753 0.035 21.510      0    0.678    0.828
#> 7 indirect :=      a*b indirect 0.245 0.019 12.747      0    0.206    0.283
#> 8   direct :=       cp   direct 0.233 0.026  8.886      0    0.168    0.283
#> 9    total := cp+(a*b)    total 0.478 0.024 20.064      0    0.421    0.518
```
