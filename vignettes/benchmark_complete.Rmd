...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0227 100 0.1906 0.2701
#> b        0.5082 0.0290 100 0.4528 0.5575
#> a        0.4820 0.0301 100 0.4196 0.5416
#> X~~X     1.0590 0.0459 100 0.9615 1.1450
#> Y~~Y     0.5462 0.0246 100 0.4999 0.5878
#> M~~M     0.7527 0.0332 100 0.6940 0.8112
#> indirect 0.2449 0.0212 100 0.2089 0.2844
#> direct   0.2333 0.0227 100 0.1906 0.2701
#> total    0.4782 0.0256 100 0.4198 0.5257
```
...
#> 1        Y  ~        X       cp 0.233 0.023 10.253      0    0.182    0.270
#> 2        Y  ~        M        b 0.508 0.027 18.863      0    0.459    0.568
#> 3        M  ~        X        a 0.482 0.028 17.254      0    0.418    0.529
#> 4        X ~~        X          1.059 0.046 22.897      0    0.959    1.149
#> 5        Y ~~        Y          0.546 0.026 21.095      0    0.483    0.591
#> 6        M ~~        M          0.753 0.035 21.227      0    0.695    0.822
#> 7 indirect :=      a*b indirect 0.245 0.021 11.770      0    0.205    0.285
#> 8   direct :=       cp   direct 0.233 0.023 10.201      0    0.182    0.270
#> 9    total := cp+(a*b)    total 0.478 0.024 20.260      0    0.410    0.519
```
