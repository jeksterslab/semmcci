...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0275 100 0.1831 0.2814
#> b        0.5082 0.0279 100 0.4537 0.5565
#> a        0.4820 0.0261 100 0.4387 0.5427
#> X~~X     1.0590 0.0445 100 0.9711 1.1388
#> Y~~Y     0.5462 0.0249 100 0.4915 0.5802
#> M~~M     0.7527 0.0374 100 0.6715 0.8239
#> indirect 0.2449 0.0187 100 0.2136 0.2813
#> direct   0.2333 0.0275 100 0.1831 0.2814
#> total    0.4782 0.0255 100 0.4369 0.5337
```
...
#> 1        Y  ~        X       cp 0.233 0.026  8.970      0    0.189    0.285
#> 2        Y  ~        M        b 0.508 0.029 17.607      0    0.442    0.573
#> 3        M  ~        X        a 0.482 0.024 20.058      0    0.435    0.531
#> 4        X ~~        X          1.059 0.042 25.027      0    0.979    1.158
#> 5        Y ~~        Y          0.546 0.021 26.330      0    0.502    0.580
#> 6        M ~~        M          0.753 0.033 22.609      0    0.673    0.812
#> 7 indirect :=      a*b indirect 0.245 0.020 12.476      0    0.200    0.279
#> 8   direct :=       cp   direct 0.233 0.026  8.925      0    0.189    0.285
#> 9    total := cp+(a*b)    total 0.478 0.026 18.118      0    0.427    0.535
```
