...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2333 0.0265 100 0.1801 0.2929
#> b        0.5082 0.0252 100 0.4618 0.5568
#> a        0.4820 0.0289 100 0.4184 0.5409
#> X~~X     1.0590 0.0466 100 0.9747 1.1671
#> Y~~Y     0.5462 0.0227 100 0.4945 0.5862
#> M~~M     0.7527 0.0328 100 0.6939 0.8102
#> indirect 0.2449 0.0173 100 0.2127 0.2778
#> direct   0.2333 0.0265 100 0.1801 0.2929
#> total    0.4782 0.0307 100 0.4172 0.5307
```
...
#> 1        Y  ~        X       cp 0.233 0.028  8.399      0    0.179    0.286
#> 2        Y  ~        M        b 0.508 0.027 18.749      0    0.435    0.560
#> 3        M  ~        X        a 0.482 0.027 17.677      0    0.425    0.540
#> 4        X ~~        X          1.059 0.047 22.623      0    0.974    1.172
#> 5        Y ~~        Y          0.546 0.023 24.092      0    0.495    0.603
#> 6        M ~~        M          0.753 0.038 20.053      0    0.675    0.825
#> 7 indirect :=      a*b indirect 0.245 0.018 13.269      0    0.205    0.288
#> 8   direct :=       cp   direct 0.233 0.028  8.357      0    0.179    0.286
#> 9    total := cp+(a*b)    total 0.478 0.027 17.428      0    0.422    0.531
```
