...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0310 100 0.1661 0.2847
#> b        0.5192 0.0379 100 0.4473 0.5834
#> a        0.4790 0.0249 100 0.4412 0.5292
#> X~~X     1.0613 0.0470 100 0.9615 1.1436
#> Y~~Y     0.5439 0.0279 100 0.4783 0.5933
#> M~~M     0.7642 0.0393 100 0.6981 0.8414
#> indirect 0.2486 0.0210 100 0.2127 0.2869
#> direct   0.2274 0.0310 100 0.1661 0.2847
#> total    0.4760 0.0256 100 0.4339 0.5370
```
...
#>   BIC                 7745.223 78.693   7583.060 7895.977
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.237    0.030    0.170    0.283
#>     M         (b)     0.509    0.034    0.450    0.576
#>   M ~
#>     X         (a)     0.479    0.023    0.440    0.520
#> 
#> Variances:
#>     X                 1.062    0.056    0.958    1.181
#>     Y                 0.551    0.026    0.499    0.594
#>     M                 0.760    0.037    0.689    0.829
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.244    0.020    0.211    0.282
#>     cp     (drct)     0.237    0.030    0.170    0.283
#>     cp+(*) (totl)     0.481    0.028    0.434    0.537
```
