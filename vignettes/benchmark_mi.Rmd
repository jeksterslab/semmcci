...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0303 100 0.1715 0.2817
#> b        0.5192 0.0310 100 0.4688 0.5832
#> a        0.4790 0.0275 100 0.4404 0.5412
#> X~~X     1.0613 0.0539 100 0.9607 1.1579
#> Y~~Y     0.5439 0.0318 100 0.4877 0.5998
#> M~~M     0.7642 0.0433 100 0.6811 0.8351
#> indirect 0.2486 0.0173 100 0.2166 0.2833
#> direct   0.2274 0.0303 100 0.1715 0.2817
#> total    0.4760 0.0292 100 0.4302 0.5402
```
...
#>   BIC                 7720.588 96.195   7569.880 7931.849
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.237    0.033    0.178    0.302
#>     M         (b)     0.512    0.034    0.448    0.581
#>   M ~
#>     X         (a)     0.486    0.029    0.430    0.528
#> 
#> Variances:
#>     X                 1.053    0.053    0.964    1.185
#>     Y                 0.548    0.030    0.491    0.607
#>     M                 0.753    0.041    0.670    0.825
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.249    0.020    0.209    0.282
#>     cp     (drct)     0.237    0.033    0.178    0.302
#>     cp+(*) (totl)     0.485    0.032    0.425    0.542
```
