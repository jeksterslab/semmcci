...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0318 100 0.1772 0.2911
#> b        0.5192 0.0369 100 0.4474 0.5817
#> a        0.4790 0.0326 100 0.4137 0.5319
#> X~~X     1.0613 0.0471 100 0.9723 1.1626
#> Y~~Y     0.5439 0.0283 100 0.4790 0.5890
#> M~~M     0.7642 0.0395 100 0.6889 0.8488
#> indirect 0.2486 0.0222 100 0.2051 0.2870
#> direct   0.2274 0.0318 100 0.1772 0.2911
#> total    0.4760 0.0308 100 0.4097 0.5301
```
...
#>   BIC                 7751.723 90.975   7580.393 7918.481
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.236    0.027    0.192    0.288
#>     M         (b)     0.511    0.029    0.460    0.564
#>   M ~
#>     X         (a)     0.480    0.031    0.422    0.535
#> 
#> Variances:
#>     X                 1.054    0.051    0.955    1.143
#>     Y                 0.557    0.028    0.496    0.603
#>     M                 0.763    0.033    0.706    0.824
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.245    0.019    0.210    0.277
#>     cp     (drct)     0.236    0.027    0.192    0.288
#>     cp+(*) (totl)     0.482    0.028    0.425    0.534
```
