...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0341 100 0.1734 0.2981
#> b        0.5192 0.0359 100 0.4545 0.5807
#> a        0.4790 0.0309 100 0.4277 0.5382
#> X~~X     1.0613 0.0451 100 0.9729 1.1421
#> Y~~Y     0.5439 0.0298 100 0.4850 0.5973
#> M~~M     0.7642 0.0425 100 0.6863 0.8505
#> indirect 0.2486 0.0206 100 0.2075 0.2878
#> direct   0.2274 0.0341 100 0.1734 0.2981
#> total    0.4760 0.0298 100 0.4262 0.5284
```
...
#>   BIC                 7741.252 84.465   7592.751 7901.327
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.239    0.027    0.173    0.283
#>     M         (b)     0.508    0.029    0.447    0.558
#>   M ~
#>     X         (a)     0.481    0.030    0.436    0.552
#> 
#> Variances:
#>     X                 1.053    0.049    0.980    1.163
#>     Y                 0.552    0.026    0.513    0.606
#>     M                 0.762    0.038    0.678    0.838
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.244    0.019    0.213    0.290
#>     cp     (drct)     0.239    0.027    0.173    0.283
#>     cp+(*) (totl)     0.484    0.028    0.426    0.540
```
