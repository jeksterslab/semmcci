...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0277 100 0.1609 0.2758
#> b        0.5192 0.0300 100 0.4597 0.5800
#> a        0.4790 0.0306 100 0.4241 0.5393
#> X~~X     1.0613 0.0495 100 0.9825 1.1714
#> Y~~Y     0.5439 0.0334 100 0.4800 0.6019
#> M~~M     0.7642 0.0385 100 0.6914 0.8372
#> indirect 0.2486 0.0183 100 0.2139 0.2813
#> direct   0.2274 0.0277 100 0.1609 0.2758
#> total    0.4760 0.0280 100 0.4151 0.5252
```
...
#>   BIC                 7725.061 84.364   7552.106 7872.834
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.237    0.029    0.173    0.285
#>     M         (b)     0.516    0.030    0.458    0.569
#>   M ~
#>     X         (a)     0.482    0.029    0.423    0.530
#> 
#> Variances:
#>     X                 1.053    0.052    0.961    1.162
#>     Y                 0.552    0.027    0.500    0.600
#>     M                 0.750    0.035    0.678    0.810
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.248    0.019    0.210    0.283
#>     cp     (drct)     0.237    0.029    0.173    0.285
#>     cp+(*) (totl)     0.486    0.031    0.411    0.539
```
