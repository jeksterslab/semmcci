...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0248 100 0.1856 0.2817
#> b        0.5192 0.0309 100 0.4644 0.5704
#> a        0.4790 0.0322 100 0.4160 0.5420
#> X~~X     1.0613 0.0484 100 0.9753 1.1669
#> Y~~Y     0.5439 0.0317 100 0.4864 0.6073
#> M~~M     0.7642 0.0401 100 0.6938 0.8455
#> indirect 0.2486 0.0197 100 0.2070 0.2806
#> direct   0.2274 0.0248 100 0.1856 0.2817
#> total    0.4760 0.0264 100 0.4267 0.5187
```
...
#>   BIC                 7749.397 73.093   7601.357 7864.815
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.239    0.032    0.180    0.295
#>     M         (b)     0.509    0.033    0.444    0.567
#>   M ~
#>     X         (a)     0.479    0.032    0.417    0.534
#> 
#> Variances:
#>     X                 1.058    0.054    0.952    1.152
#>     Y                 0.557    0.028    0.499    0.598
#>     M                 0.759    0.033    0.697    0.812
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.244    0.024    0.201    0.288
#>     cp     (drct)     0.239    0.032    0.180    0.295
#>     cp+(*) (totl)     0.483    0.030    0.424    0.534
```
