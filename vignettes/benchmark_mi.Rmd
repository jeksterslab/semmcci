...
#>             est     se   R   2.5%  97.5%
#> cp       0.2374 0.0325 100 0.1636 0.2924
#> b        0.5065 0.0324 100 0.4401 0.5625
#> a        0.4793 0.0271 100 0.4249 0.5325
#> X~~X     1.0480 0.0499 100 0.9437 1.1316
#> Y~~Y     0.5499 0.0286 100 0.4965 0.6105
#> M~~M     0.7610 0.0354 100 0.6952 0.8306
#> indirect 0.2428 0.0203 100 0.2111 0.2865
#> direct   0.2374 0.0325 100 0.1636 0.2924
#> total    0.4802 0.0311 100 0.4239 0.5312
```
...
#>   BIC                 7884.178 97.907   7702.885 8072.443
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.242    0.031    0.187    0.302
#>     M         (b)     0.517    0.033    0.457    0.575
#>   M ~
#>     X         (a)     0.499    0.028    0.445    0.551
#> 
#> Variances:
#>     X                 1.096    0.060    0.990    1.212
#>     Y                 0.580    0.031    0.528    0.637
#>     M                 0.805    0.042    0.719    0.877
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.258    0.019    0.225    0.296
#>     cp     (drct)     0.242    0.031    0.187    0.302
#>     cp+(*) (totl)     0.500    0.031    0.451    0.568
```
