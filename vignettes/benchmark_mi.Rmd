...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0329 100 0.1714 0.3027
#> b        0.5192 0.0339 100 0.4525 0.5802
#> a        0.4790 0.0282 100 0.4326 0.5326
#> X~~X     1.0613 0.0493 100 0.9781 1.1591
#> Y~~Y     0.5439 0.0302 100 0.4768 0.5860
#> M~~M     0.7642 0.0412 100 0.6793 0.8332
#> indirect 0.2486 0.0214 100 0.2086 0.2862
#> direct   0.2274 0.0329 100 0.1714 0.3027
#> total    0.4760 0.0290 100 0.4192 0.5384
```
...
#>   BIC                 7748.042 86.348   7559.698 7883.365
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.238    0.029    0.177    0.286
#>     M         (b)     0.503    0.032    0.442    0.565
#>   M ~
#>     X         (a)     0.484    0.032    0.427    0.546
#> 
#> Variances:
#>     X                 1.058    0.052    0.957    1.168
#>     Y                 0.558    0.026    0.501    0.600
#>     M                 0.756    0.039    0.685    0.839
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.244    0.020    0.208    0.287
#>     cp     (drct)     0.238    0.029    0.177    0.286
#>     cp+(*) (totl)     0.482    0.028    0.433    0.535
```
