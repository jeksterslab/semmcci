...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0322 100 0.1785 0.2899
#> b        0.5192 0.0324 100 0.4558 0.5686
#> a        0.4790 0.0276 100 0.4266 0.5357
#> X~~X     1.0613 0.0462 100 0.9773 1.1559
#> Y~~Y     0.5439 0.0267 100 0.4944 0.5979
#> M~~M     0.7642 0.0365 100 0.7104 0.8356
#> indirect 0.2486 0.0195 100 0.2133 0.2836
#> direct   0.2274 0.0322 100 0.1785 0.2899
#> total    0.4760 0.0305 100 0.4289 0.5410
```
...
#>   BIC                 7736.891 86.474   7545.503 7885.126
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.240    0.029    0.183    0.287
#>     M         (b)     0.506    0.035    0.445    0.578
#>   M ~
#>     X         (a)     0.486    0.030    0.428    0.537
#> 
#> Variances:
#>     X                 1.051    0.055    0.960    1.159
#>     Y                 0.553    0.027    0.501    0.605
#>     M                 0.759    0.036    0.686    0.825
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.246    0.024    0.204    0.289
#>     cp     (drct)     0.240    0.029    0.183    0.287
#>     cp+(*) (totl)     0.486    0.024    0.430    0.522
```
