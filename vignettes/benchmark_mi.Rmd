...
#>             est     se   R   2.5%  97.5%
#> cp       0.2366 0.0295 100 0.1724 0.2916
#> b        0.5118 0.0266 100 0.4653 0.5636
#> a        0.4943 0.0283 100 0.4458 0.5436
#> X~~X     1.0563 0.0516 100 0.9587 1.1570
#> Y~~Y     0.5641 0.0275 100 0.5164 0.6099
#> M~~M     0.7433 0.0383 100 0.6750 0.8304
#> indirect 0.2530 0.0195 100 0.2187 0.2923
#> direct   0.2366 0.0295 100 0.1724 0.2916
#> total    0.4896 0.0287 100 0.4396 0.5415
```
...
#>   BIC                 7884.178 95.723   7682.401 8070.561
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.242    0.035    0.177    0.308
#>     M         (b)     0.517    0.033    0.452    0.573
#>   M ~
#>     X         (a)     0.499    0.032    0.430    0.553
#> 
#> Variances:
#>     X                 1.096    0.058    0.988    1.203
#>     Y                 0.580    0.032    0.516    0.624
#>     M                 0.805    0.043    0.731    0.881
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.258    0.022    0.210    0.297
#>     cp     (drct)     0.242    0.035    0.177    0.308
#>     cp+(*) (totl)     0.500    0.036    0.439    0.565
```
