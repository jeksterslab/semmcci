...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0302 100 0.1700 0.2836
#> b        0.5192 0.0310 100 0.4719 0.5770
#> a        0.4790 0.0324 100 0.4216 0.5383
#> X~~X     1.0613 0.0424 100 0.9826 1.1497
#> Y~~Y     0.5439 0.0301 100 0.4901 0.5944
#> M~~M     0.7642 0.0386 100 0.7019 0.8387
#> indirect 0.2486 0.0202 100 0.2172 0.2916
#> direct   0.2274 0.0302 100 0.1700 0.2836
#> total    0.4760 0.0290 100 0.4279 0.5301
```
...
#>   BIC                 7743.472 79.252   7584.255 7883.795
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.232    0.032    0.175    0.302
#>     M         (b)     0.506    0.033    0.442    0.575
#>   M ~
#>     X         (a)     0.486    0.030    0.433    0.535
#> 
#> Variances:
#>     X                 1.053    0.052    0.955    1.152
#>     Y                 0.558    0.030    0.496    0.620
#>     M                 0.755    0.039    0.681    0.821
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.246    0.022    0.200    0.287
#>     cp     (drct)     0.232    0.032    0.175    0.302
#>     cp+(*) (totl)     0.478    0.032    0.420    0.537
```
...
#> 1   MC   402.1562   424.174   430.9003   429.5631   439.4205   450.5282    10
#> 2   NB 41397.6614 41794.043 41954.8281 41989.5391 42217.1283 42339.4703    10
```
...
#>   expr      min       lq     mean   median       uq     max neval
#> 1   MC   1.0000  1.00000  1.00000  1.00000  1.00000  1.0000    10
#> 2   NB 102.9393 98.53043 97.36551 97.74941 96.07455 93.9774    10
```
...
#>   expr        min         lq       mean     median        uq        max neval
#> 1   MC   271.1255   281.4969   289.9931   292.2079   297.381   307.6737    10
#> 2   NB 41352.0173 41558.1923 41739.6044 41615.1297 41968.220 42210.8682    10
```
...
#> 2   NB 152.5199 147.6329 143.9331 142.4162 141.1261 137.1936    10
```
