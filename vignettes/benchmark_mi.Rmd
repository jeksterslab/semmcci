...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0312 100 0.1626 0.2843
#> b        0.5192 0.0320 100 0.4631 0.5892
#> a        0.4790 0.0321 100 0.4279 0.5465
#> X~~X     1.0613 0.0480 100 0.9925 1.1674
#> Y~~Y     0.5439 0.0293 100 0.4837 0.5944
#> M~~M     0.7642 0.0390 100 0.6892 0.8341
#> indirect 0.2486 0.0197 100 0.2123 0.2963
#> direct   0.2274 0.0312 100 0.1626 0.2843
#> total    0.4760 0.0293 100 0.4192 0.5216
```
...
#>   BIC                 7738.578 79.223   7569.361 7879.804
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.237    0.032    0.174    0.298
#>     M         (b)     0.512    0.034    0.452    0.572
#>   M ~
#>     X         (a)     0.480    0.027    0.430    0.538
#> 
#> Variances:
#>     X                 1.055    0.053    0.959    1.157
#>     Y                 0.551    0.027    0.505    0.599
#>     M                 0.760    0.032    0.702    0.824
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.246    0.020    0.206    0.278
#>     cp     (drct)     0.237    0.032    0.174    0.298
#>     cp+(*) (totl)     0.483    0.028    0.429    0.535
```
