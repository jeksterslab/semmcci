...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0276 100 0.1757 0.2802
#> b        0.5192 0.0350 100 0.4604 0.5825
#> a        0.4790 0.0277 100 0.4384 0.5404
#> X~~X     1.0613 0.0465 100 0.9601 1.1469
#> Y~~Y     0.5439 0.0312 100 0.4843 0.6086
#> M~~M     0.7642 0.0355 100 0.7036 0.8317
#> indirect 0.2486 0.0198 100 0.2110 0.2884
#> direct   0.2274 0.0276 100 0.1757 0.2802
#> total    0.4760 0.0264 100 0.4275 0.5313
```
...
#>   BIC                 7732.877 85.503   7556.597 7867.546
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.242    0.029    0.181    0.288
#>     M         (b)     0.514    0.034    0.448    0.572
#>   M ~
#>     X         (a)     0.474    0.031    0.426    0.547
#> 
#> Variances:
#>     X                 1.062    0.058    0.940    1.198
#>     Y                 0.547    0.028    0.496    0.601
#>     M                 0.756    0.033    0.687    0.810
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.244    0.021    0.214    0.293
#>     cp     (drct)     0.242    0.029    0.181    0.288
#>     cp+(*) (totl)     0.486    0.030    0.430    0.543
```
