...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2419 0.0328 100 0.1809 0.2947
#> b        0.5166 0.0296 100 0.4551 0.5774
#> a        0.4989 0.0339 100 0.4385 0.5621
#> X~~X     1.0951 0.0592 100 0.9883 1.2103
#> Y~~Y     0.5796 0.0311 100 0.5250 0.6362
#> M~~M     0.8045 0.0425 100 0.7374 0.8873
#> indirect 0.2577 0.0254 100 0.2160 0.3034
#> direct   0.2419 0.0328 100 0.1809 0.2947
#> total    0.4996 0.0356 100 0.4272 0.5669
```
...
#> 1         Y  ~        X       cp  0.234 0.033  7.004  0.000    0.165    0.300
#> 2         Y  ~        M        b  0.511 0.031 16.704  0.000    0.449    0.568
#> 3         M  ~        X        a  0.481 0.030 15.995  0.000    0.415    0.532
#> 4         X ~~        X           1.059 0.048 21.945  0.000    0.958    1.153
#> 5         Y ~~        Y           0.554 0.023 24.465  0.000    0.496    0.599
#> 6         M ~~        M           0.756 0.036 20.749  0.000    0.683    0.852
#> 7         Y ~1                   -0.013 0.026 -0.497  0.619   -0.072    0.034
#> 8         M ~1                   -0.022 0.030 -0.743  0.458   -0.084    0.032
#> 9         X ~1                    0.002 0.033  0.076  0.940   -0.077    0.066
#> 10 indirect :=      a*b indirect  0.246 0.020 12.100  0.000    0.203    0.287
#> 11   direct :=       cp   direct  0.234 0.034  6.968  0.000    0.165    0.300
#> 12    total := cp+(a*b)    total  0.479 0.033 14.485  0.000    0.394    0.547
```
