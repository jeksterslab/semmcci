...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2419 0.0363 100 0.1800 0.3176
#> b        0.5166 0.0357 100 0.4386 0.5856
#> a        0.4989 0.0337 100 0.4399 0.5703
#> X~~X     1.0951 0.0498 100 1.0038 1.1829
#> Y~~Y     0.5796 0.0324 100 0.5216 0.6437
#> M~~M     0.8045 0.0390 100 0.7316 0.8763
#> indirect 0.2577 0.0228 100 0.2145 0.3004
#> direct   0.2419 0.0363 100 0.1800 0.3176
#> total    0.4996 0.0366 100 0.4409 0.5794
```
...
#> 1         Y  ~        X       cp  0.234 0.031  7.496  0.000    0.162    0.309
#> 2         Y  ~        M        b  0.511 0.031 16.555  0.000    0.444    0.579
#> 3         M  ~        X        a  0.481 0.029 16.446  0.000    0.411    0.533
#> 4         X ~~        X           1.059 0.050 21.172  0.000    0.958    1.151
#> 5         Y ~~        Y           0.554 0.025 21.822  0.000    0.501    0.606
#> 6         M ~~        M           0.756 0.036 20.864  0.000    0.684    0.829
#> 7         Y ~1                   -0.013 0.026 -0.498  0.619   -0.066    0.036
#> 8         M ~1                   -0.022 0.029 -0.765  0.444   -0.083    0.038
#> 9         X ~1                    0.002 0.032  0.077  0.938   -0.073    0.057
#> 10 indirect :=      a*b indirect  0.246 0.020 12.354  0.000    0.204    0.293
#> 11   direct :=       cp   direct  0.234 0.031  7.458  0.000    0.162    0.309
#> 12    total := cp+(a*b)    total  0.479 0.032 15.202  0.000    0.414    0.545
```
