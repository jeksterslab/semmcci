...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2419 0.0342 100 0.1780 0.3113
#> b        0.5166 0.0393 100 0.4505 0.5923
#> a        0.4989 0.0298 100 0.4561 0.5564
#> X~~X     1.0951 0.0587 100 0.9911 1.1960
#> Y~~Y     0.5796 0.0347 100 0.5192 0.6501
#> M~~M     0.8045 0.0428 100 0.7286 0.8830
#> indirect 0.2577 0.0249 100 0.2250 0.3078
#> direct   0.2419 0.0342 100 0.1780 0.3113
#> total    0.4996 0.0312 100 0.4348 0.5503
```
...
#> 1         Y  ~        X       cp  0.234 0.030  7.829  0.000    0.176    0.299
#> 2         Y  ~        M        b  0.511 0.028 18.195  0.000    0.457    0.572
#> 3         M  ~        X        a  0.481 0.030 16.196  0.000    0.421    0.539
#> 4         X ~~        X           1.059 0.053 20.101  0.000    0.958    1.162
#> 5         Y ~~        Y           0.554 0.028 20.119  0.000    0.495    0.613
#> 6         M ~~        M           0.756 0.039 19.637  0.000    0.687    0.847
#> 7         Y ~1                   -0.013 0.024 -0.520  0.603   -0.058    0.039
#> 8         M ~1                   -0.022 0.027 -0.833  0.405   -0.085    0.026
#> 9         X ~1                    0.002 0.035  0.072  0.943   -0.072    0.080
#> 10 indirect :=      a*b indirect  0.246 0.020 12.465  0.000    0.212    0.282
#> 11   direct :=       cp   direct  0.234 0.030  7.790  0.000    0.176    0.299
#> 12    total := cp+(a*b)    total  0.479 0.028 16.990  0.000    0.426    0.536
```
