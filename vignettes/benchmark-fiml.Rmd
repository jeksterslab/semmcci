...
#> Monte Carlo Confidence Intervals
#>             est     se   R   2.5%  97.5%
#> cp       0.2419 0.0326 100 0.1861 0.3189
#> b        0.5166 0.0317 100 0.4604 0.5811
#> a        0.4989 0.0322 100 0.4435 0.5634
#> X~~X     1.0951 0.0567 100 0.9690 1.1844
#> Y~~Y     0.5796 0.0289 100 0.5222 0.6323
#> M~~M     0.8045 0.0452 100 0.7384 0.8972
#> indirect 0.2577 0.0227 100 0.2219 0.3111
#> direct   0.2419 0.0326 100 0.1861 0.3189
#> total    0.4996 0.0332 100 0.4421 0.5688
```
...
#> 1         Y  ~        X       cp  0.234 0.032  7.252  0.000    0.158    0.299
#> 2         Y  ~        M        b  0.511 0.031 16.580  0.000    0.455    0.577
#> 3         M  ~        X        a  0.481 0.028 17.426  0.000    0.416    0.530
#> 4         X ~~        X           1.059 0.049 21.403  0.000    0.966    1.164
#> 5         Y ~~        Y           0.554 0.027 20.242  0.000    0.494    0.601
#> 6         M ~~        M           0.756 0.033 22.760  0.000    0.678    0.820
#> 7         Y ~1                   -0.013 0.027 -0.468  0.639   -0.064    0.057
#> 8         M ~1                   -0.022 0.029 -0.776  0.438   -0.078    0.035
#> 9         X ~1                    0.002 0.035  0.071  0.943   -0.067    0.069
#> 10 indirect :=      a*b indirect  0.246 0.020 12.425  0.000    0.207    0.289
#> 11   direct :=       cp   direct  0.234 0.032  7.215  0.000    0.158    0.299
#> 12    total := cp+(a*b)    total  0.479 0.031 15.714  0.000    0.400    0.537
```
