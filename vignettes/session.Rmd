...
#> [4] lavaan_0.6-19        semmcci_1.1.4.9000  
#> 
#> loaded via a namespace (and not attached):
#>  [1] tidyr_1.3.1       generics_0.1.3    shape_1.4.6.1     bmemLavaan_0.5   
#>  [5] lattice_0.22-6    mitml_0.4-5       lme4_1.1-35.5     magrittr_2.0.3   
#>  [9] evaluate_1.0.1    grid_4.4.1        iterators_1.0.14  mice_3.17.0      
#> [13] jomo_2.7-6        foreach_1.5.2     glmnet_4.1-8      rprojroot_2.0.4  
#> [17] Matrix_1.7-0      nnet_7.3-19       backports_1.5.0   snowfall_1.84-6.3
#> [21] survival_3.6-4    purrr_1.0.2       rProject_0.0.14   mi_1.1           
#> [25] pbivnorm_0.6.0    codetools_0.2-20  abind_1.4-8       mnormt_2.1.1     
#> [29] cli_3.6.3.9001    rlang_1.1.4       splines_4.4.1     pan_1.9          
#> [33] rsem_0.5.1        tools_4.4.1       parallel_4.4.1    nloptr_2.1.1     
#> [37] coda_0.19-4.1     minqa_1.2.8       dplyr_1.1.4       boot_1.3-30      
#> [41] broom_1.0.7       rpart_4.1.23      vctrs_0.6.5       sem_3.1-16       
#> [45] R6_2.5.1          stats4_4.4.1      lifecycle_1.0.4   MASS_7.3-60.2    
#> [49] foreign_0.8-86    pkgconfig_2.0.3   pillar_1.10.0     glue_1.8.0       
#> [53] tidyselect_1.2.1  arm_1.14-4        xfun_0.49         tibble_3.2.1     
#> [57] knitr_1.49        nlme_3.1-164      snow_0.4-4        compiler_4.4.1   
#> [61] quadprog_1.5-8
```
...
#> shape             "shape"             "1.4.6.1"    
#> shiny             "shiny"             "1.10.0"     
#> simStateSpace     "simStateSpace"     "1.2.3.9000" 
#> slider            "slider"            "0.3.2"      
#> snow              "snow"              "0.4-4"      
...
#> Mem:           125Gi       3.7Gi        61Gi       5.6Gi        61Gi       115Gi
#> Swap:             0B          0B          0B
#> Total:         125Gi       3.7Gi        61Gi
```
