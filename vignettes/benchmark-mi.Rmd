...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0322 100 0.1670 0.2885
#> b        0.5192 0.0336 100 0.4521 0.5816
#> a        0.4790 0.0291 100 0.4297 0.5402
#> X~~X     1.0613 0.0503 100 0.9793 1.1736
#> Y~~Y     0.5439 0.0301 100 0.4888 0.6028
#> M~~M     0.7642 0.0375 100 0.7004 0.8309
#> indirect 0.2486 0.0189 100 0.2172 0.2931
#> direct   0.2274 0.0322 100 0.1670 0.2885
#> total    0.4760 0.0295 100 0.4213 0.5318
```
...
#>   BIC                 7755.838 74.513   7568.296 7857.896
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.229    0.028    0.186    0.287
#>     M         (b)     0.521    0.031    0.447    0.571
#>   M ~
#>     X         (a)     0.472    0.031    0.427    0.538
#> 
#> Variances:
#>     X                 1.073    0.047    0.963    1.147
#>     Y                 0.551    0.026    0.496    0.596
#>     M                 0.761    0.039    0.665    0.818
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.246    0.021    0.205    0.287
#>     cp     (drct)     0.229    0.028    0.186    0.287
#>     cp+(*) (totl)     0.475    0.029    0.432    0.537
```
