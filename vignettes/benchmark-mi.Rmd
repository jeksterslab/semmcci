...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0354 100 0.1606 0.2954
#> b        0.5192 0.0336 100 0.4595 0.5907
#> a        0.4790 0.0247 100 0.4231 0.5256
#> X~~X     1.0613 0.0534 100 0.9771 1.1677
#> Y~~Y     0.5439 0.0321 100 0.4860 0.6074
#> M~~M     0.7642 0.0394 100 0.6874 0.8362
#> indirect 0.2486 0.0185 100 0.2097 0.2796
#> direct   0.2274 0.0354 100 0.1606 0.2954
#> total    0.4760 0.0300 100 0.4078 0.5260
```
...
#>   BIC                 7735.933 87.239   7543.516 7868.140
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.231    0.029    0.171    0.282
#>     M         (b)     0.510    0.033    0.443    0.569
#>   M ~
#>     X         (a)     0.487    0.031    0.428    0.545
#> 
#> Variances:
#>     X                 1.056    0.051    0.959    1.150
#>     Y                 0.548    0.025    0.503    0.602
#>     M                 0.761    0.039    0.683    0.816
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.249    0.023    0.206    0.288
#>     cp     (drct)     0.231    0.029    0.171    0.282
#>     cp+(*) (totl)     0.479    0.030    0.416    0.535
```
