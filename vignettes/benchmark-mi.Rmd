...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0300 100 0.1765 0.2888
#> b        0.5192 0.0318 100 0.4666 0.5879
#> a        0.4790 0.0318 100 0.4288 0.5435
#> X~~X     1.0613 0.0489 100 0.9585 1.1628
#> Y~~Y     0.5439 0.0350 100 0.4814 0.6093
#> M~~M     0.7642 0.0428 100 0.6753 0.8407
#> indirect 0.2486 0.0187 100 0.2147 0.2831
#> direct   0.2274 0.0300 100 0.1765 0.2888
#> total    0.4760 0.0304 100 0.4233 0.5341
```
...
#>   BIC                 7728.974 86.015   7596.793 7913.973
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.227    0.033    0.169    0.299
#>     M         (b)     0.520    0.033    0.440    0.564
#>   M ~
#>     X         (a)     0.479    0.030    0.426    0.535
#> 
#> Variances:
#>     X                 1.058    0.051    0.968    1.143
#>     Y                 0.543    0.026    0.497    0.602
#>     M                 0.762    0.039    0.684    0.837
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.249    0.022    0.205    0.288
#>     cp     (drct)     0.227    0.033    0.169    0.299
#>     cp+(*) (totl)     0.476    0.029    0.416    0.533
```
