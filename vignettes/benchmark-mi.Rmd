...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0339 100 0.1705 0.3000
#> b        0.5192 0.0340 100 0.4621 0.5816
#> a        0.4790 0.0286 100 0.4303 0.5369
#> X~~X     1.0613 0.0522 100 0.9538 1.1593
#> Y~~Y     0.5439 0.0299 100 0.4887 0.6020
#> M~~M     0.7642 0.0383 100 0.7172 0.8503
#> indirect 0.2486 0.0203 100 0.2136 0.2957
#> direct   0.2274 0.0339 100 0.1705 0.3000
#> total    0.4760 0.0317 100 0.4220 0.5366
```
...
#>   BIC                 7735.882 77.810   7598.411 7901.272
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.234    0.030    0.173    0.284
#>     M         (b)     0.503    0.028    0.465    0.575
#>   M ~
#>     X         (a)     0.482    0.031    0.421    0.540
#> 
#> Variances:
#>     X                 1.068    0.048    0.968    1.160
#>     Y                 0.547    0.026    0.507    0.604
#>     M                 0.754    0.036    0.694    0.826
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.242    0.021    0.213    0.290
#>     cp     (drct)     0.234    0.030    0.173    0.284
#>     cp+(*) (totl)     0.476    0.030    0.423    0.535
```
...
#> 1   MC   313.5029   319.1802   326.359   325.6054   330.5382   349.4236    10
#> 2   NB 30771.3994 31013.2461 31315.277 31338.8656 31537.9076 31891.5797    10
```
...
#> 2   NB 98.15348 97.16532 95.95346 96.24799 95.41381 91.26911    10
```
...
#>   expr        min         lq       mean     median        uq        max neval
#> 1   MC   201.0391   207.1486   214.4645   212.2069   221.695   238.0166    10
#> 2   NB 30514.3583 30544.3787 30678.7887 30690.7368 30769.238 30879.3730    10
```
...
#> 2   NB 151.7832 147.4515 143.0483 144.6265 138.7909 129.7362    10
```
