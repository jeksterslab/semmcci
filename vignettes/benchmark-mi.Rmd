...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0317 100 0.1719 0.2859
#> b        0.5192 0.0345 100 0.4598 0.5870
#> a        0.4790 0.0313 100 0.4148 0.5354
#> X~~X     1.0613 0.0473 100 0.9603 1.1547
#> Y~~Y     0.5439 0.0306 100 0.4926 0.6034
#> M~~M     0.7642 0.0386 100 0.7050 0.8520
#> indirect 0.2486 0.0214 100 0.2053 0.2871
#> direct   0.2274 0.0317 100 0.1719 0.2859
#> total    0.4760 0.0288 100 0.4227 0.5203
```
...
#>   BIC                 7745.402 86.437   7580.390 7903.022
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.235    0.033    0.165    0.291
#>     M         (b)     0.508    0.030    0.455    0.574
#>   M ~
#>     X         (a)     0.480    0.028    0.433    0.539
#> 
#> Variances:
#>     X                 1.059    0.057    0.946    1.178
#>     Y                 0.557    0.030    0.498    0.606
#>     M                 0.755    0.034    0.708    0.824
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.244    0.021    0.210    0.289
#>     cp     (drct)     0.235    0.033    0.165    0.291
#>     cp+(*) (totl)     0.479    0.028    0.425    0.532
```
