...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0310 100 0.1738 0.2861
#> b        0.5192 0.0347 100 0.4551 0.5926
#> a        0.4790 0.0278 100 0.4195 0.5414
#> X~~X     1.0613 0.0447 100 0.9520 1.1277
#> Y~~Y     0.5439 0.0259 100 0.4878 0.5886
#> M~~M     0.7642 0.0327 100 0.7085 0.8317
#> indirect 0.2486 0.0204 100 0.2167 0.2930
#> direct   0.2274 0.0310 100 0.1738 0.2861
#> total    0.4760 0.0277 100 0.4186 0.5346
```
...
#>   BIC                 7735.862 88.265   7568.240 7896.226
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.237    0.031    0.169    0.287
#>     M         (b)     0.503    0.029    0.466    0.570
#>   M ~
#>     X         (a)     0.477    0.027    0.432    0.534
#> 
#> Variances:
#>     X                 1.060    0.052    0.963    1.155
#>     Y                 0.550    0.027    0.500    0.600
#>     M                 0.756    0.038    0.684    0.825
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.240    0.020    0.205    0.285
#>     cp     (drct)     0.237    0.031    0.169    0.287
#>     cp+(*) (totl)     0.477    0.032    0.407    0.533
```
...
#> 1   MC   464.8932   478.787   489.9163   490.6511   506.025   507.7778    10
#> 2   NB 46595.5377 47108.318 47130.7820 47159.6097 47226.895 47583.2396    10
```
...
#>   expr      min       lq    mean   median       uq      max neval
#> 1   MC   1.0000  1.00000  1.0000  1.00000  1.00000  1.00000    10
#> 2   NB 100.2285 98.39097 96.2017 96.11638 93.32917 93.70878    10
```
...
#>   expr       min         lq       mean     median         uq        max neval
#> 1   MC   332.543   337.6777   340.3419   339.9049   344.8413   347.4041    10
#> 2   NB 46797.020 47058.6514 47173.8080 47179.5178 47306.5077 47521.2820    10
```
...
#> 2   NB 140.7247 139.3597 138.6071 138.8021 137.1834 136.7896    10
```
