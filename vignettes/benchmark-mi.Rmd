...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0300 100 0.1708 0.2907
#> b        0.5192 0.0367 100 0.4475 0.5795
#> a        0.4790 0.0316 100 0.4219 0.5360
#> X~~X     1.0613 0.0436 100 0.9710 1.1399
#> Y~~Y     0.5439 0.0309 100 0.4862 0.5981
#> M~~M     0.7642 0.0409 100 0.6962 0.8483
#> indirect 0.2486 0.0209 100 0.2110 0.2814
#> direct   0.2274 0.0300 100 0.1708 0.2907
#> total    0.4760 0.0299 100 0.4136 0.5286
```
...
#>   BIC                 7741.187 80.293   7572.791 7898.778
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.241    0.031    0.166    0.288
#>     M         (b)     0.509    0.028    0.460    0.555
#>   M ~
#>     X         (a)     0.476    0.030    0.423    0.543
#> 
#> Variances:
#>     X                 1.056    0.052    0.986    1.186
#>     Y                 0.550    0.025    0.495    0.595
#>     M                 0.764    0.037    0.688    0.820
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.243    0.020    0.208    0.283
#>     cp     (drct)     0.241    0.031    0.166    0.288
#>     cp+(*) (totl)     0.484    0.031    0.424    0.530
```
