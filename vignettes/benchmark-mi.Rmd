...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0341 100 0.1632 0.2898
#> b        0.5192 0.0339 100 0.4528 0.5908
#> a        0.4790 0.0281 100 0.4223 0.5256
#> X~~X     1.0613 0.0464 100 0.9853 1.1740
#> Y~~Y     0.5439 0.0326 100 0.4774 0.6082
#> M~~M     0.7642 0.0382 100 0.7066 0.8545
#> indirect 0.2486 0.0211 100 0.2066 0.2899
#> direct   0.2274 0.0341 100 0.1632 0.2898
#> total    0.4760 0.0324 100 0.4115 0.5308
```
...
#>   BIC                 7731.837 85.104   7574.679 7892.073
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.229    0.028    0.181    0.285
#>     M         (b)     0.514    0.031    0.459    0.580
#>   M ~
#>     X         (a)     0.484    0.034    0.417    0.547
#> 
#> Variances:
#>     X                 1.052    0.051    0.969    1.164
#>     Y                 0.554    0.025    0.504    0.599
#>     M                 0.754    0.036    0.693    0.832
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.248    0.024    0.210    0.291
#>     cp     (drct)     0.229    0.028    0.181    0.285
#>     cp+(*) (totl)     0.478    0.029    0.423    0.534
```
...
#> 1   MC   540.9599   568.212   600.3437   578.4989   596.0327   822.0181    10
#> 2   NB 51384.4184 52457.165 53299.0057 53236.5930 54007.2817 55428.0348    10
```
...
#> 2   NB 94.98748 92.31971 88.78081 92.0254 90.61127 67.42921    10
```
...
#>   expr        min         lq      mean     median         uq        max neval
#> 1   MC   350.0974   358.0486   370.171   370.5188   381.1251   391.7083    10
#> 2   NB 50886.8273 51692.3403 52043.942 51951.5707 52239.3573 53723.9259    10
```
...
#> 2   NB 145.3505 144.3724 140.5943 140.213 137.0662 137.1529    10
```
