...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0305 100 0.1636 0.2864
#> b        0.5192 0.0336 100 0.4561 0.5812
#> a        0.4790 0.0307 100 0.4250 0.5314
#> X~~X     1.0613 0.0471 100 0.9770 1.1536
#> Y~~Y     0.5439 0.0306 100 0.4904 0.6018
#> M~~M     0.7642 0.0394 100 0.6882 0.8280
#> indirect 0.2486 0.0196 100 0.2150 0.2822
#> direct   0.2274 0.0305 100 0.1636 0.2864
#> total    0.4760 0.0259 100 0.4262 0.5216
```
...
#>   BIC                 7729.383 92.363   7560.438 7892.144
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.233    0.030    0.178    0.285
#>     M         (b)     0.519    0.034    0.442    0.561
#>   M ~
#>     X         (a)     0.485    0.028    0.428    0.537
#> 
#> Variances:
#>     X                 1.047    0.061    0.961    1.196
#>     Y                 0.556    0.031    0.499    0.608
#>     M                 0.752    0.036    0.686    0.826
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.252    0.021    0.208    0.284
#>     cp     (drct)     0.233    0.030    0.178    0.285
#>     cp+(*) (totl)     0.485    0.028    0.424    0.541
```
