...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0327 100 0.1663 0.2772
#> b        0.5192 0.0302 100 0.4708 0.5819
#> a        0.4790 0.0287 100 0.4358 0.5356
#> X~~X     1.0613 0.0518 100 0.9839 1.1685
#> Y~~Y     0.5439 0.0304 100 0.4830 0.5943
#> M~~M     0.7642 0.0389 100 0.6734 0.8288
#> indirect 0.2486 0.0213 100 0.2185 0.2940
#> direct   0.2274 0.0327 100 0.1663 0.2772
#> total    0.4760 0.0279 100 0.4218 0.5263
```
...
#>   BIC                 7741.371 89.508   7597.419 7921.963
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.229    0.035    0.172    0.302
#>     M         (b)     0.517    0.033    0.449    0.568
#>   M ~
#>     X         (a)     0.485    0.030    0.433    0.540
#> 
#> Variances:
#>     X                 1.061    0.046    0.975    1.140
#>     Y                 0.552    0.029    0.492    0.602
#>     M                 0.757    0.041    0.678    0.832
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.251    0.021    0.209    0.281
#>     cp     (drct)     0.229    0.035    0.172    0.302
#>     cp+(*) (totl)     0.479    0.032    0.413    0.547
```
