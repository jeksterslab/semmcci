...
#>             est     se   R   2.5%  97.5%
#> cp       0.2274 0.0287 100 0.1716 0.2799
#> b        0.5192 0.0345 100 0.4526 0.5823
#> a        0.4790 0.0335 100 0.4156 0.5446
#> X~~X     1.0613 0.0527 100 0.9809 1.1675
#> Y~~Y     0.5439 0.0273 100 0.4974 0.6064
#> M~~M     0.7642 0.0394 100 0.6958 0.8451
#> indirect 0.2486 0.0244 100 0.2104 0.2966
#> direct   0.2274 0.0287 100 0.1716 0.2799
#> total    0.4760 0.0303 100 0.4190 0.5345
```
...
#>   BIC                 7760.659 82.480   7597.388 7880.993
...
#> Regressions:
#>   Y ~
#>     X        (cp)     0.244    0.033    0.180    0.292
#>     M         (b)     0.503    0.033    0.455    0.578
#>   M ~
#>     X         (a)     0.477    0.028    0.428    0.537
#> 
#> Variances:
#>     X                 1.064    0.051    0.964    1.152
#>     Y                 0.561    0.023    0.512    0.603
#>     M                 0.757    0.038    0.673    0.821
#> 
#> 
#> 
#> Defined parameters:
#>     a*b    (indr)     0.240    0.020    0.209    0.283
#>     cp     (drct)     0.244    0.033    0.180    0.292
#>     cp+(*) (totl)     0.484    0.028    0.425    0.530
```
